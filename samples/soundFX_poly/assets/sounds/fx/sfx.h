// FILE created by NGFX SoundBuilder v0.210808 [ReAdd]
...
#define ADPCM_MUTE (0x16)
#define ADPCM_SET_MAX_VOL (0x17)
...
// SoundBank 00
#define ADPCM_BELL (0x20)
#define ADPCM_FAIL (0x21)
#define ADPCM_ALARM01 (0x22)
