...
/**
 * @brief Picture data container for auto-generated structures
 * @details Container structure holding pointers to picture and palette information.
 *          Used by auto-generated GFX_DAT_Pict_ROM structures from project XML configuration.
 *
 * @struct GFX_DAT_Pict_ROM
 * @var GFX_DAT_Pict_ROM::pictureInfo Pointer to DATlib picture information
 * @var GFX_DAT_Pict_ROM::paletteInfo Pointer to DATlib palette information
 *
 * @note This structure is typically auto-generated by the build toolchain
 * @since 3.4.3
 *
 * @see GFX_Picture
 */
typedef struct GFX_DAT_Pict_ROM {
  const pictureInfo *pictureInfo;
  const paletteInfo *paletteInfo;  
} GFX_DAT_Pict_ROM;

/**
 * @brief Scroller data container for auto-generated structures
 * @details Container structure holding pointers to scroller and palette information.
 *          Used by auto-generated GFX_DAT_Scrl_ROM structures from project XML configuration.
 *
 * @struct GFX_DAT_Scrl_ROM
 * @var GFX_DAT_Scrl_ROM::scrollerInfo Pointer to DATlib scroller information
 * @var GFX_DAT_Scrl_ROM::paletteInfo Pointer to DATlib palette information
 *
 * @note This structure is typically auto-generated by the build toolchain
 * @since 3.4.3
 *
 * @see GFX_Scroller
 */
typedef struct GFX_DAT_Scrl_ROM {
  const scrollerInfo *scrollerInfo;
  const paletteInfo *paletteInfo;  
} GFX_DAT_Scrl_ROM;

/**
 * @brief Sprite data container for auto-generated structures
 * @details Container structure holding pointers to sprite and palette information.
 *          Used by auto-generated GFX_DAT_Sprt_ROM structures from project XML configuration.
 *
 * @struct GFX_DAT_Sprt_ROM
 * @var GFX_DAT_Sprt_ROM::spriteInfo Pointer to DATlib sprite information
 * @var GFX_DAT_Sprt_ROM::paletteInfo Pointer to DATlib palette information
 *
 * @note This structure is typically auto-generated by the build toolchain
 * @since 3.4.3
 *
 * @see GFX_Animated_Sprite
 */
typedef struct GFX_DAT_Sprt_ROM {
